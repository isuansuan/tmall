<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"C:\AppServ\www\tmall\public/../application/index\view\car\shopwin.html";i:1523689947;s:62:"C:\AppServ\www\tmall\application\index\view\Index\header1.html";i:1524212128;s:61:"C:\AppServ\www\tmall\application\index\view\Index\footer.html";i:1521526231;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="UTF-8">
...
<div class='header1_btn'>
  ...
  <div class='header1_btn_right'>
    ...
    <div class='shopWin_content'>
      <div class='shopWin_Cboth'>
        <div class='shopWin_Ctop'>
          <div class='shopWin_Cleft'>
             <i class="iconfont icon-success"></i>
          </div>
          <div class='shopWin_Cright'>
            <p>
              您以成功付款
            </p>
          </div>
        </div>
        <div class='shopWin_Cbottom'>
          <ul>
            <li>
              <span>
                实付款: <i class='shopWin_CbottomA'>￥<?php echo $data['tot']; ?></i>
              </span>
            </li>
             <li>
               <span>
                 收货地址: <i class='shopWin_CbottomB'><?php echo $data['province']; ?><?php echo $data['city']; ?><?php echo $data['county']; ?><?php echo $data['addr']; ?></i>
               </span>
            </li>
             <li>
              <span>
             ...
             <li>
              <span>
                订单号: <i class='shopWin_CbottomC'><?php echo $data['code']; ?></i>
              </span>
            </li>
          </ul>
          <p>
            您可以 &nbsp;<a href="<?php echo url('person/indent'); ?>">查看已买到的宝贝</a> &nbsp; <a href="javascript:;">查看交易详情</a>
          </p>
        </div>
        <div class='shopWin_CbottomBotm'>
          <div class='shopWin_CbottomBotmBoth'>
            <b>
              安全提醒:
            </b>
            <span>下单后, &nbsp;</span>
            <span class='shopWin_CbottomBotmBothA'>用QQ给您发送链接办理退款的都是骗子！</span>
            <span>天猫不存在系统升级，订单异常等问题，谨防假冒客服电话诈骗！</span>
          </div>
        </div>
      </div>
