<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"C:\AppServ\www\tmall\public/../application/admin\view\comment\index.html";i:1524450168;s:55:"C:\AppServ\www\tmall\application\admin\view\layout.html";i:1524455925;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="UTF-8">
...
<div class="panel panel-default">
  ...
  <!-- Table -->
   ...
   <tr>
     ...
     <td><div><?php echo $dat['content']; ?></div></td>
     <td>
       <?php if(is_array($dat['imgs']) || $dat['imgs'] instanceof \think\Collection || $dat['imgs'] instanceof \think\Paginator): $i = 0; $__LIST__ = $dat['imgs'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$img): $mod = ($i % 2 );++$i;?>
       <img src="/static/upload/comment/<?php echo $img; ?>" alt="" width='50px' height='40px'>
       <?php endforeach; endif; else: echo "" ;endif; ?>
     </td>
     <td><?php echo $dat['time']; ?></td>
     <td><a href="<?php echo url('Comment/del',array('id'=>$dat['id'])); ?>" class='btn btn-danger'>删除</a></td>
   </tr>
   <?php endforeach; endif; else: echo "" ;endif; ?>
