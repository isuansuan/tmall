<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"C:\AppServ\www\tmall\public/../application/admin\view\shop\index.html";i:1524327649;s:55:"C:\AppServ\www\tmall\application\admin\view\layout.html";i:1524455925;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="UTF-8">
...
<div class="panel panel-default">
  ...
  <div class="panel-heading">
    ...
    <a href="<?php echo url('Shop/add'); ?>" class='btn btn-info'> <span class='glyphicon glyphicon-plus'></span>添加商品</a>
  ...
  <!-- Table -->
   <table class='table table-hover '>
    ...
    <tr>
      ...
      <td><div title='<?php echo $dat['introduce']; ?>'><?php echo $dat['introduce']; ?></div></td>
      <td class='shopImg'><img src="/static/upload/shop/<?php echo $dat['img']; ?>" alt="" style='width:50px;height:50px;cursor: pointer;' data-toggle="modal" data-target=".bs-example-modal-sm"></td>
      <td><?php echo $dat['price']; ?>元</td>
      <td><?php echo $dat['internet']; ?></td>
      <td><?php echo $dat['screen']; ?>英寸</td>
      ...
      <td><a href="<?php echo url('Shop/edit',array('id'=>$dat['id'])); ?>" class='btn btn-info'>修改</a>
      	<a href="<?php echo url('Shop/del',array('id'=>$dat['id'])); ?>" class='btn btn-warning'>删除</a>
      </td>
    </tr>
...
<div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
  <div class="modal-dialog modal-sm">
    <div class="modal-content shopImgBig">
      <img src="/static/upload/shop/" alt="" style='width:200px;height:200px' >
    </div>
  </div>
</div>
<script>
$('.shopImg').click(function(){
  ...
  $('.shopImgBig').children().attr('src',a);
})
