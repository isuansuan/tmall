<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"C:\AppServ\www\tmall\public/../application/admin\view\dindan\edit.html";i:1523262789;s:55:"C:\AppServ\www\tmall\application\admin\view\layout.html";i:1524455925;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="UTF-8">
...
<div class="breadcrumb">
  ...
  <div class="modal-body">
    <form action='<?php echo url("Dindan/update"); ?>' id='' enctype="multipart/form-data" method="post">
      ...
      <div class="form-group">
        ...
        <select class="form-control"  name='status_id'>
          <?php if(is_array($status) || $status instanceof \think\Collection || $status instanceof \think\Paginator): $i = 0; $__LIST__ = $status;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$stau): $mod = ($i % 2 );++$i;?>
          <option value='<?php echo $stau['id']; ?>'<?php echo $sid==$stau['id']?'selected':''; ?> ><?php echo $stau['sname']; ?></option>
