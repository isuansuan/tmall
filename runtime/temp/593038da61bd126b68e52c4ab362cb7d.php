<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"C:\AppServ\www\tmall\public/../application/admin\view\prodimg\cedit.html";i:1522821275;s:55:"C:\AppServ\www\tmall\application\admin\view\layout.html";i:1524455925;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="UTF-8">
...
<form  method="post" enctype="multipart/form-data" action="<?php echo url('cUpload'); ?>"  id="box">  
   <div class="form-group">
        ...
        <select class="form-control"  name='shop_id'>
          ...
          <option value='<?php echo $dat['id']; ?>' <?php echo $prodbotimg['shop_id']==$dat['id']?'selected':''; ?>><?php echo $dat['sname']; ?></option>
          <?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
      </div>
      <input type="hidden" name="oldimg" value='<?php echo $prodbotimg['img']; ?>'>
      <input type="hidden" name="id" value='<?php echo $prodbotimg['id']; ?>'>
      <div width='100px';height='100px';border='1px solid #f00';>
        <img src="/static/upload/prodimg/<?php echo $prodbotimg['img']; ?>" alt="" width='150px' height='150px' >
      </div>
      <div class="form-group">
        <label for="exampleInputPassword1">机身颜色</label>
        <input type="text" class="form-control" name='color' value='<?php echo $prodbotimg['color']; ?>'>
      </div>
      <div class="form-group">
        <label for="exampleInputPassword1">机身内存</label>
        <input type="text" class="form-control" name='neicun' value='<?php echo $prodbotimg['neicun']; ?>'>
      </div> 
    <!--file包裹-->  
