<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"C:\AppServ\www\tmall\public/../application/admin\view\brand\index.html";i:1524210978;s:55:"C:\AppServ\www\tmall\application\admin\view\layout.html";i:1524455925;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="UTF-8">
...
<div class="panel panel-default">
  ...
  <div class="panel-heading">
    ...
    <a href="<?php echo url('Brand/add'); ?>" class='btn btn-info'> <span class='glyphicon glyphicon-plus'></span>添加品牌</a>
  ...
  <!-- Table -->
   <table class='table table-hover '>
    ...
    <tr>
      ...
      <td><img src="/static/upload/brand/<?php echo $dat['img']; ?>" alt="" style='width:80px;height:80px'></td>
      <td><a href="<?php echo url('brand/edit',array('id'=>$dat['id'])); ?>" class='btn btn-info'>修改</a></td>
      <td><a href="<?php echo url('brand/del',array('id'=>$dat['id'])); ?>" class='btn btn-warning'>删除</a></td>
    </tr>
