<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"C:\AppServ\www\tmall\public/../application/admin\view\shop\add.html";i:1522464296;s:55:"C:\AppServ\www\tmall\application\admin\view\layout.html";i:1524455925;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="UTF-8">
    ...
    <form action='' id='' enctype="multipart/form-data" method="post">
      <div class="form-group">
        ...
        <select class="form-control"  name='brand_id'>
          ...
          <option value='<?php echo $dat['id']; ?>'><?php echo $dat['bname']; ?></option>
      ...
      <div class="form-group">
        ...
        <div id="queue" style='width:100px;height:100px;border:1px solid #ccc'></div>
      </div>
      <div class="form-group">
      ...
      <div class="radio">
        <label>
          <input type="radio" name="shelf" id="optionsRadios2" value="0">
          上架
        </label>
      </div>
      <div class="radio">
        <label>
          <input type="radio" name="shelf" id="optionsRadios3" value="1">
          下架
        </label>
      </div>
