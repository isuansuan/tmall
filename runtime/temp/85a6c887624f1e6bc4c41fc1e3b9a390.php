<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"C:\AppServ\www\tmall\public/../application/admin\view\prodimg\cindex.html";i:1524210842;s:55:"C:\AppServ\www\tmall\application\admin\view\layout.html";i:1524455925;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="UTF-8">
...
<div class="panel panel-default">
  ...
  <div class="panel-heading">
    ...
    <a href="<?php echo url('prodimg/cadd'); ?>" class='btn btn-info'> <span class='glyphicon glyphicon-plus'></span>添加机身颜色图片</a>
  ...
  <!-- Table -->
   <table class='table table-hover '>
    ...
    <tr>
      ...
      <td><?php echo $dat['neicun']; ?></td>
      <td class='BrandbgImg'><img src="/static/upload/prodcolor/<?php echo $dat['img']; ?>" alt="" style='width:30px;height:30px;cursor: pointer;' data-toggle="modal" data-target=".bs-example-modal-lg"></td>
      <td><a href="<?php echo url('prodimg/cedit',array('id'=>$dat['id'])); ?>" class='btn btn-info'>修改</a>
      	<a href="<?php echo url('prodimg/cdel',array('id'=>$dat['id'])); ?>" class='btn btn-warning'>删除</a>
      </td>
    </tr>
