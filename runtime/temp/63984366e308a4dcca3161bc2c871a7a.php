<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"C:\AppServ\www\tmall\public/../application/admin\view\shop\edit.html";i:1522466816;s:55:"C:\AppServ\www\tmall\application\admin\view\layout.html";i:1524455925;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="UTF-8">
...
<div class="breadcrumb">
  ...
  <div class="modal-body">
    <form action='<?php echo url("shop/update"); ?>' id='' enctype="multipart/form-data" method="post">
      <div class="form-group">
        ...
        <select class="form-control"  name='brand_id'>
          ...
          <option value='<?php echo $brad['id']; ?>' <?php echo $data['brand_id']==$brad['id']?'selected':''; ?>><?php echo $brad['bname']; ?></option>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" name='introduce' value='<?php echo $data['introduce']; ?>'>
      </div>
      <div class="form-group">
        <label for="exampleInputEmail1">原图</label>
        <input type="hidden" name="oldimg" id='oldimg' value='<?php echo $data['img']; ?>'>
        <input type="hidden" name="id" id='id' value='<?php echo $data['id']; ?>'>
        <div id="" style='width:100px;height:100px;border:1px solid #ccc'>
          <img src="/static/upload/shop/<?php echo $data['img']; ?>" alt="" width='100px' height='100px'>
        </div>
      </div>
      <div class="form-group">
        ...
        <div id="queue" style='width:105px;height:105px;border:1px solid #ccc'></div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        <label for="exampleInputPassword1">网络类型</label>
        <input type="text" class="form-control" name='internet' value='<?php echo $data['internet']; ?>'>
      </div>
      <div class="form-group">
        <label for="exampleInputPassword1">屏幕大小</label>
        <input type="text" class="form-control" name='screen' value='<?php echo $data['screen']; ?>'>
      </div>
      <div class="form-group">
      ...
      <div class="radio">
        <label>
          <input type="radio" name="shelf" id="optionsRadios2" value="0" <?php echo $data['shelf']=='0'?'checked':''; ?>>
          上架
        </label>
      </div>
      <div class="radio">
        <label>
          <input type="radio" name="shelf" id="optionsRadios3" value="1" <?php echo $data['shelf']=='1'?'checked':''; ?>>
          下架
        </label>
      </div>
  ...
  $(function() {
    $('#file_upload').uploadify({
      ...
      onUploadSuccess:function(file,data,response){
        img="<img src='/static/upload/shop/"+data+"' alt='' width='100px' height='100px'>"
        $('#queue').html(img);
        $('#img').val(data);
      }
    });
