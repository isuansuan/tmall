<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"C:\AppServ\www\tmall\public/../application/admin\view\dindan\index.html";i:1524451225;s:55:"C:\AppServ\www\tmall\application\admin\view\layout.html";i:1524455925;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="UTF-8">
  ...
  <!-- Table -->
   <table class='table table-hover '>
    ...
    <tr>
      ...
      <td><a href="<?php echo url('Dindan/ordershop',array('code'=>$dat['code'])); ?>" class='btn btn-success' >下单商品</a></td>
      <td><?php echo $dat['time']; ?></td>
       <td><?php echo $dat['sname']; ?></td>
      <td><a href="<?php echo url('Dindan/contact',array('cid'=>$dat['contact_id'])); ?>" class='btn btn-success' >联系方式</a></td>
      <td><?php if($dat['affirm'] == '0'): ?>
          否
        <?php else: ?>
          是
        <?php endif; ?></td>
      <td><a href="<?php echo url('Dindan/edit',array('code'=>$dat['code'],'sid'=>$dat['status_id'])); ?>" class='btn btn-info'>修改状态</a></td>
      <td><a href="<?php echo url('Dindan/del',array('code'=>$dat['code'])); ?>" class='btn btn-danger'>删除</a></td>
    </tr>
