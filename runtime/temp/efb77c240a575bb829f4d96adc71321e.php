<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"C:\AppServ\www\tmall\public/../application/index\view\person\indent3.html";i:1524450905;s:62:"C:\AppServ\www\tmall\application\index\view\Index\header3.html";i:1524212106;s:61:"C:\AppServ\www\tmall\application\index\view\Index\footer.html";i:1521526231;}*/ ?>
<!doctype html>
<html>
<head>
  <meta charset="UTF-8">
  <title>好生活上天猫-待收货</title>
      ...
      <div class="indent_right_A">
        <ul>
          ...
          <li class='indent_right_A_a'>
            <a href="<?php echo url('person/indent3'); ?>" style='color:#f40'>待收货</a>
            <span>|</span>
          </li>
          <li>
        ...
        <div class='indent_right_E_bottom'>
          <div class='indent_right_E_bottom_a'>
            ...
            <div class='indent_right_E_bottom_a1'>
              ...
              <p>
                <span>
                  颜色分类：<?php echo $dat['color']; ?><br>
                  内存大小：<?php echo $dat['neicun']; ?>
                </span>
              </p>
              <p>
          ...
          <div class='indent_right_E_bottom_g'>
            <dl class='indent3_okshop'>
              <dd>
                <a href="<?php echo url('Car/qrsh',array('code'=>$dat['code'],'shopid'=>$dat['shop_id'])); ?>">确认收货</a>
              </dd>
            </dl>
          </div>
        </div>
