<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"C:\AppServ\www\tmall\public/../application/index\view\person\footmark.html";i:1524103602;s:62:"C:\AppServ\www\tmall\application\index\view\Index\header3.html";i:1524212106;s:61:"C:\AppServ\www\tmall\application\index\view\Index\footer.html";i:1521526231;}*/ ?>
<!doctype html>
<html>
<head>
  <meta charset="UTF-8">
  <title>理想生活上天猫--足迹</title>
  ...
  <link rel="stylesheet" href="/static/public/css/index.css">
    ...
    <link rel="stylesheet" href="/static/public/css/footmark.css">
...
<div class='main'>
 ...
 <div class='clear'></div>
    <div class='person_content'>
      ...
      <?php if($footshops): if(is_array($footshops) || $footshops instanceof \think\Collection || $footshops instanceof \think\Paginator): $i = 0; $__LIST__ = $footshops;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$footshop): $mod = ($i % 2 );++$i;?>
      <div class='clear'></div>
      <div class='liulantime'>
        <p>浏览时间 : <span><?php echo $footshop['time']; ?></span></p>
      </div> 
      <div class='clear'></div>
      <div class='collectshop'>
        <?php if(is_array($footshop['shops']) || $footshop['shops'] instanceof \think\Collection || $footshop['shops'] instanceof \think\Paginator): $i = 0; $__LIST__ = $footshop['shops'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$footshopa): $mod = ($i % 2 );++$i;?>
        <div class='collectshopA'>
          <div class='collectshopAimg'>
           <a href="<?php echo url('Index/product',array('id'=>$footshopa['id'])); ?>">
             <img src="/static/upload/shop/<?php echo $footshopa['img']; ?>" alt="">
           </a>
           <div class='close' onclick='footdel(<?php echo $footshopa['id']; ?>,this)'>
             <span>&times;</span>
           </div>
          </div>
          <div class='collectshopAsname'>
            <i><img src="/static/public/img/confirmOrderTmall.png" alt=""></i>
            <a href=""><?php echo $footshopa['sname']; ?><?php echo $footshopa['introduce']; ?></a>
          </div>
          <div class='collectshopAprice'>
            <span>￥<?php echo $footshopa['price']; ?>.00</span>
          </div>
        </div>
...
<script>
 function footdel(id,obj){
  $.post('<?php echo url("ajax_footdel"); ?>',{id:id},function(data){
    if(data==1){
