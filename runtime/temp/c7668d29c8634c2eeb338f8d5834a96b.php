<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"C:\AppServ\www\tmall\public/../application/admin\view\lunbo\index.html";i:1524210900;s:55:"C:\AppServ\www\tmall\application\admin\view\layout.html";i:1524455925;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="UTF-8">
...
<div class="panel panel-default">
  ...
  <div class="panel-heading">
    ...
    <a href="<?php echo url('Lunbo/add'); ?>" class='btn btn-info'> <span class='glyphicon glyphicon-plus'></span>添加轮播</a>
  ...
  <!-- Table -->
   <table class='table table-hover '>
    ...
    <tr>
      ...
      <td class='LunboImg'><img src="/static/upload/lunbo/<?php echo $dat['img']; ?>" alt="" style='width:200px;height:50px;cursor: pointer;' data-toggle="modal" data-target=".bs-example-modal-lg"></td>
      <td><?php echo $dat['href']; ?></td>
      <td><input type="text" name='sort' value='<?php echo $dat['sort']; ?>' onblur='sort(<?php echo $dat['id']; ?>,this)' style='border:none;outline:none'></td>
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
  <div class="modal-dialog modal-lg">
    <div class="modal-content LunboImgBig">
      <img src="/static/upload/lunbo/" alt="" style='width:1000px;height:300px' data-toggle="modal" data-target=".bs-example-modal-lg">
    </div>
  </div>
</div>
<script>
...
$('.LunboImg').click(function(){
  a=$(this).children().attr('src')
  $('.LunboImgBig').children().attr('src',a);
})
</script>
