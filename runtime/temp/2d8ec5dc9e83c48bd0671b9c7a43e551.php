<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"C:\AppServ\www\tmall\public/../application/index\view\person\indent1.html";i:1524450887;s:62:"C:\AppServ\www\tmall\application\index\view\Index\header3.html";i:1524212106;s:61:"C:\AppServ\www\tmall\application\index\view\Index\footer.html";i:1521526231;}*/ ?>
<!doctype html>
<html>
<head>
  <meta charset="UTF-8">
  <title>好生活上天猫-待付款</title>
 ...
 <div class='clear'></div>
   ...
   <div class="indent_content">
    ...
    <div class="indent_right">
      <div class="indent_right_A">
        <ul>
          ...
          <li class='indent_right_A_a'>
            <a href="<?php echo url('person/indent1'); ?>" style='color:#f40'>代付款</a>
            <span>|</span>
          </li>
          <li>
      ...
      <div class='indent_right_B'>
        <form action="">
          <div class='indent_right_B_b'>
            <input type="text" name="" id="" placeholder='输入商品标题或订单号进行查询'>
          </div>
      ...
      <?php else: if(is_array($shops) || $shops instanceof \think\Collection || $shops instanceof \think\Paginator): $i = 0; $__LIST__ = $shops;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$shop): $mod = ($i % 2 );++$i;?>
   ...
   <div class='indentshops'>
    <div class='indentshops_A'>
     ...
     <?php if(is_array($moreshops) || $moreshops instanceof \think\Collection || $moreshops instanceof \think\Paginator): $i = 0; $__LIST__ = $moreshops;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$moreshop): $mod = ($i % 2 );++$i;?>
     <div class='indentshops_B'>
      ...
      <div class='indentshops_B_price'>
        <span class='price'>￥<?php echo $moreshop['price']; ?>.00</span>
        <span class='jprice'>￥<?php echo $moreshop['price'] + 499; ?>.00</span>
        <a href=""></a>
      </div>
      <div class='indentshops_B_name'>
        <p>
          <a href="<?php echo url('Index/product',array('id'=>$moreshop['id'])); ?>">
            <?php echo $moreshop['sname']; ?><?php echo $moreshop['introduce']; ?>
          </a>
        </p>
      </div>
      <div class='indentshops_B_stock'>
        <span>
          库存：<?php echo $moreshop['stock']; ?>件
        </span>
        <a href="">
          优惠促销
        </a>
