<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"C:\AppServ\www\tmall\public/../application/index\view\person\indent5.html";i:1524450928;s:62:"C:\AppServ\www\tmall\application\index\view\Index\header3.html";i:1524212106;s:61:"C:\AppServ\www\tmall\application\index\view\Index\footer.html";i:1521526231;}*/ ?>
<!doctype html>
<html>
<head>
  <meta charset="UTF-8">
  <title>好生活上天猫-已评价</title>
       ...
       <div class='indent_right_E_bottom'>
         ...
         <div class='indent_right_E_bottom_g'>
           <dl class='indent3_okshop'>
             <dd>
               <a href="<?php echo url('Index/product',array('id'=>$dat['shop_id'])); ?>">再次购买</a>
             </dd>
           </dl>
         </div>
       </div>
    ...
    <div class='indentshops_A'>
     ...
     <div class='indentshops_B'>
      ...
      <div class='indentshops_B_name'>
        <p>
          <a href="<?php echo url('Index/product',array('id'=>$shop['id'])); ?>">
            <?php echo $shop['sname']; ?><?php echo url('Index/product',array('id'=>$shop['id'])); ?>$shop.introduce}
          </a>
        </p>
      </div>
