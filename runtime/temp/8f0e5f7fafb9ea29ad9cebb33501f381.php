<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"C:\AppServ\www\tmall\public/../application/admin\view\data\index.html";i:1524212372;s:55:"C:\AppServ\www\tmall\application\admin\view\layout.html";i:1524455925;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="UTF-8">
  ...
  <!-- Table -->
   <table class='table table-hover '>
    ...
    <tr id='tr<?php echo $dat['id']; ?>'>
      ...
      <td>
        <a href="javascript:;" class='btn btn-info' onclick='datafu(<?php echo $dat['id']; ?>,this)'>恢复</a> &nbsp;<a href="javascript:;" onclick='del(<?php echo $dat['id']; ?>,this)' class='btn btn-danger'>删除</a> </td>
    </tr>
...
<script>
  function datafu(id,obj){
    $.post('<?php echo url("ajax_datafu"); ?>',{id:id},function(data){
       if(data==1){
  ...
  function dataAll(){
   ...
   str=arr.join(',',arr);
   $.post('<?php echo url("ajax_dataAll"); ?>',{str:str},function(data){
      if(data==1){
