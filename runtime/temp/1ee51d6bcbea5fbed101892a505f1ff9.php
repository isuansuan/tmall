<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"C:\AppServ\www\tmall\public/../application/index\view\person\indent.html";i:1524450867;s:62:"C:\AppServ\www\tmall\application\index\view\Index\header3.html";i:1524212106;s:61:"C:\AppServ\www\tmall\application\index\view\Index\footer.html";i:1521526231;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="UTF-8">
	<title>好生活上天猫-我的订单</title>
 ...
 <div class='clear'></div>
   ...
   <div class="indent_content">
    ...
    <div class="indent_right">
      <div class="indent_right_A">
        <ul>
          <li class='indent_right_A_a'>
            <a href="<?php echo url('person/indent'); ?>" style='color:#f40'>所有订单</a>
            <span>|</span>
          </li>
          <li>
          ...
          <li>
            <a href="<?php echo url('person/indent2'); ?>">代发货</a>
            <span>|</span>
          </li>
          <li>
      ...
      <div class='indent_right_B'>
        <form action="">
          <div class='indent_right_B_b'>
            <input type="text" id="" name='search' placeholder='输入商品标题或订单号进行查询'>
          </div>
      ...
      <?php else: if(is_array($indents) || $indents instanceof \think\Collection || $indents instanceof \think\Paginator): $i = 0; $__LIST__ = $indents;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$indent): $mod = ($i % 2 );++$i;?>
      <div class='indent_right_E'>
        <div class='indent_right_E_top'>
          <div class='indent_right_E_top_a'>
            <input type="checkbox" name="" id="">
            <span><?php echo $indent['time']; ?></span>
            <span>订单号：<?php echo $indent['code']; ?></span>
          </div>
          ...
          <div class='indent_right_E_top_d'>
            <a href="javascript:;" onclick='indentdel(<?php echo $indent['id']; ?>,this)'>
        ...
        <div class='indent_right_E_bottom'>
          <div class='indent_right_E_bottom_a'>
            <a href="<?php echo url('Index/product',array('id'=>$indent['shop_id'])); ?>">
              <img src="/static/upload/shop/<?php echo $indent['img']; ?>" alt="">
            </a>
            <div class='indent_right_E_bottom_a1'>
              <p>
                <a href="">
                  <?php echo $indent['sname']; ?>
                </a>
              </p>
              <p>
                <span>
                  颜色分类：<?php echo $indent['color']; ?><br>内存大小：<?php echo $indent['neicun']; ?>
                </span>
              </p>
              <p>
          ...
          <div class='indent_right_E_bottom_b'>
            <p>
              <span>
                ￥<?php echo $indent['price'] + 499; ?>
              </span>
            </p>
            <p>
              <span>
                ￥<?php echo $indent['price']; ?>
              </span>
            </p>
          </div>
          <div class='indent_right_E_bottom_c'>
            <p>
              <span>x<?php echo $indent['num']; ?></span>
            </p>
          </div>
          ...
          <div class='indent_right_E_bottom_e'>
            <p>
              ￥<?php echo $indent['price'] * $indent['num']; ?>
            </p>
            <p>
              <span>
                (含运费：￥0.00)
          ...
          <div class='indent_right_E_bottom_g'>
            <dl class='indent3_okshop'>
              <?php switch($indent['affirm']): case "1": switch($indent['status_id']): case "4": ?>
                    <dd>
                      <a href="<?php echo url('person/evaluate',array('id'=>$indent['shop_id'])); ?>">追加评论</a>
                    </dd>
                    <dd>
                      <a href="<?php echo url('Index/product',array('id'=>$indent['shop_id'])); ?>">再次购买</a>
                    </dd>
                 <?php break; ?>
                 {break/}
                 <?php case "3": ?> 
                     <dd>
                       <a href="<?php echo url('person/evaluate',array('id'=>$indent['shop_id'])); ?>">评论</a>
                     </dd>
                  <?php break; ?>
                  {break/}
                 <?php endswitch; break; ?>
              {break/}
              <?php case "0": switch($indent['status_id']): case "1": ?> 
                     <dd>
                       <a href="javascript:;">等待发货</a>
                     </dd>
                  <?php break; ?>
                  {break/}
                  <?php case "3": ?> 
                     <dd>
                       <a href="<?php echo url('Person/indent3',array('id'=>$indent['shop_id'])); ?>">还未收货</a>
                     </dd>
                  <?php break; ?>
                  {break/}
                 <?php endswitch; break; ?>
